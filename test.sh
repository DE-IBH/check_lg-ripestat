...
chkrun 1 ./check_lg-ripestat --asn=15372 --prefix=212.111.224.0/19 --peerings=3320,13237,20676 --pw=500:
chkrun 2 ./check_lg-ripestat --asn=15372 --prefix=212.111.224.0/19 --peerings=3320,13237,20676 --pc=500:
